...
function GetCRC32Algorithm(var Alg: IHashAlgorithm): TF_RESULT;
...
procedure TCRC32Alg.Init;
begin
  FValue:= $FFFFFFFF;
end;

procedure TCRC32Alg.Update(Data: PByte; DataSize: LongWord);
var
  Tmp: LongWord;
...
procedure TCRC32Alg.Done(PDigest: PLongWord);
begin
  PDigest^:= not FValue;
  FValue:= 0;
end;

function TCRC32Alg.GetHashSize: LongInt;
begin
  Result:= 4;
end;

procedure TCRC32Alg.Purge;
begin
  FValue:= 0;
end;
